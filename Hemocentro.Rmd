...
está com nome de 'CIDADE' e no de pop_cidades está como 'MUNICIPIO'.
...
a proporção de doaçõa será diferente em uma mesma cidade para homens e para mulheres.
```{r}
...
#### Exibindo proporção de doaçoes para cada gênero em todas as 10 cidades com maior proporção para cada gênero
```{r}
